...
replace ergo.services/registrar/zk => github.com/qjpcpu/registrar/zk v0.0.0-20260127115641-c3e402c0d915

require (
	ergo.services/ergo v1.999.311-0.20260130075926-ed8c381bbce9
